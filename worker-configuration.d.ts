/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3cf30e9c4409b1790e5759a2cb44f647)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		AI_STUDIO_GUARD_MODEL: string;
		AI_STUDIO_ASK_MODEL: string;
		OPENROUTER_GUARD_MODEL: string;
		OPENROUTER_ASK_MODEL: string;
		ENVIRONMENT: string;
		ASK_WORKFLOW: Workflow<Parameters<import("./src/index").AskWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_BOT_TOKEN" | "DISCORD_PUBLIC_KEY" | "DISCORD_APPLICATION_ID" | "OPENROUTER_API_KEY" | "INTERNAL_API_URL" | "LANGFUSE_PUBLIC_KEY" | "LANGFUSE_SECRET_KEY" | "LANGFUSE_BASE_URL" | "AI_STUDIO_API_KEY" | "AI_STUDIO_GUARD_MODEL" | "AI_STUDIO_ASK_MODEL" | "OPENROUTER_GUARD_MODEL" | "OPENROUTER_ASK_MODEL" | "ENVIRONMENT">> {}
}
